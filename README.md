...
|------|------|------------|--------|---------------|
| **Mugdha Sarker Anik** | 2K2507030 | CSE | [@mugdha-sarkar81](https://github.com/mugdha-sarker81) | Frontend, Architecture, Deployment, Presentation Voice,Initial design, Promotion Video |
